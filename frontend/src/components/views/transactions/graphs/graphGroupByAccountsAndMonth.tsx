...
export default function GraphGroupByAccountsAndMonth() {
    ...
    const secondsFrom=useRef(500000000000000000);
    ...
    async function createGraphByTimeStamp(dataFormated: any) {
        setGraph(new Chart(
            document.getElementById("chart3") as ChartItem,
            {
                type: "line",
                data: {
                        ...
                        x: {
                            ...
                            ticks: {
                                callback(tickValue, index, ticks) {
                                    return moment.unix(tickValue as number).format("MM/Y")
                                },
                            }
                        ...
                        tooltip: {
                            callbacks: {
                                ...
                                title: function (context) {
                                    ...
                                    return moment.unix(time as number).format("MM/Y")
                                },
    ...
    return (
        <div>
            <h2>Graph - Amount of Accounts Transactions in Months</h2>
            <h4>Max Seconds</h4>
            <input ref={secondsFromInput} type="number" defaultValue="500000" placeholder="FromTime" />
