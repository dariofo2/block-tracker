...
export default function GraphGroupByAccountsAndDay() {
    ...
    const secondsFrom=useRef(500000);
                        ...
                        x: {
                            ...
                            ticks: {
                                callback(tickValue, index, ticks) {
                                    return moment.unix(tickValue as number).format("DD/MM/Y")
                                },
                            }
                        ...
                        tooltip: {
                            callbacks: {
                                ...
                                title: function (context) {
                                    ...
                                    return moment.unix(time as number).format("DD/MM/Y")
                                },
    ...
    return (
        <div>
            <h2>Graph - Amount of Accounts Transactions in Days</h2>
            <h4>Max Seconds</h4>
